...
use Vitorccs\LaravelCsv\Tests\Data\Imports\NoHeadings\FromDiskImport as NoHeadingsImport;
use Vitorccs\LaravelCsv\Tests\Data\Imports\WithHeadings\FromDiskImport as WithHeadingsImport;

class FromDiskTest extends AbstractTestCase
{
    public function test_all_from_disk()
    {
        $imports = [
    ...
    public function test_limit_from_disk()
    {
        $limit = rand(1, 9);
